 ...
 */
 ...
 LAUNCH_BOUND(THREAD_NUM_512) inline void find_ptr_with_digest_kernel_vf(
     __gm__ Bucket<K, V, S>* buckets_gm, uint64_t capacity, uint64_t buckets_num, uint32_t bucket_capacity, uint32_t dim, __gm__ K* keys_gm,
     __gm__ V * __gm__* value_ptrs_gm, __gm__ S * scores_gm, __gm__ bool* founds_gm, uint64_t n, const uint64_t total_thread_num,
 ...
 __global__ __vector__ void find_ptr_with_digest_kernel(
     ...
     uint32_t bucket_capacity, uint32_t dim, __gm__ K* keys, __gm__ V * __gm__* value_ptrs,
     __gm__ S * scores, __gm__ bool* founds, uint64_t n, uint64_t global_epoch,
