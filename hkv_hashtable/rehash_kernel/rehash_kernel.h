 ...
 */
 ...
 __simt_vf__ __aicore__ LAUNCH_BOUND(THREAD_NUM_512) inline void rehash_kernel_vf(
 ...
 template <class K, class V, class S>
 __global__ __vector__ void rehash_kernel(
     __gm__ Table<K, V, S>* table_gm, const size_t old_buckets_num) {
   ...
   Simt::VF_CALL<rehash_kernel_vf<K, V, S>>(
                     Simt::Dim3{THREAD_NUM_512}, table, old_buckets_num,
