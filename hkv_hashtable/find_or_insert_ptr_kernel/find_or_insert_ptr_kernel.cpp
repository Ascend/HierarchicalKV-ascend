...
/*!
 * \file find_or_insert_ptr_kernel.cpp
 * \brief find_or_insert_ptr_kernel
 */

#include "./v35/find_or_insert_ptr_kernel.h"
#include <cstdint>
...
extern "C" __global__ __aicore__ void find_or_insert_ptr_kernel(
  ...
  DISPATCH_VALUE_SIZE(
      ...
      DISPATCH_EVICT_STRATEGY(
          evict_strategy,
          (Simt::VF_CALL<find_or_insert_ptr_kernel_vf<uint64_t, DTYPE, uint64_t,
                                                      STRATEGY>>(
