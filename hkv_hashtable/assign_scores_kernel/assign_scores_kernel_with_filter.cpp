...
/*!
 * \file assign_scores_kernel_with_filter.cpp
 * \brief assign_scores_kernel_with_filter
 */

#include "./v35/assign_scores_kernel_with_filter.h"
#include <cstdint>
...
extern "C" __global__ __aicore__ void assign_scores_kernel_with_filter(
  ...
  DISPATCH_VALUE_SIZE(
      ...
      DISPATCH_EVICT_STRATEGY(
          evict_strategy,
          (Simt::VF_CALL<assign_scores_kernel_with_filter_vf<
