 ...
 */
 ...
 __global__ __vector__ void find_ptr_kernel(
     ...
     GM_ADDR scores, GM_ADDR founds, uint64_t n, uint64_t global_epoch) {
   ...
   Simt::VF_CALL<find_ptr_kernel_vf<K, V, S>>(
           ...
           buckets_num, bucket_capacity, dim, keys, value_ptrs, scores, founds,
           n, thread_all, global_epoch, GetBlockIdx());
 }
 }  // namespace hkv
 }  // namespace npu
